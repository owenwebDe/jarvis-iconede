...
description: Patterns for coordinating work delegation in multi-agent teams. Covers sequential and parallel task dispatch, review checkpoints, and quality gates.
---

# Subagent Coordination

Inspired by [NeoLabHQ/subagent-driven-development](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/sadd/skills/subagent-driven-development).
...
As PM in a meeting:
- Assign clear tasks to DEV: "Implement X in file Y"
- Ask QE to review after DEV completes
- If FAIL verdict, direct DEV to fix specific issues
