...
class OpenRouterLLM(OpenAILLM):
    ...
    def _initialize_default_params(self, kwargs: dict) -> RequestParams:
        ...
        # Cap OpenRouter maxTokens to 4096 to prevent 402 credit reservation errors on low-balance keys
        if base_params.maxTokens is None or base_params.maxTokens > 4096:
    ...
    def _provider_default_headers(self) -> dict[str, str] | None:
        """Provide custom OpenRouter identification headers."""
        return {
            "HTTP-Referer": os.getenv("OPENROUTER_HTTP_REFERER", "https://jarvis.ai"),
            "X-Title": os.getenv("OPENROUTER_TITLE", "Jarvis AI OS"),
        }
