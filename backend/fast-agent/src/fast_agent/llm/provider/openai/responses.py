...
class ResponsesLLM(
    ...
    def _build_response_args(
        ...
        raw_model = request_params.model or self.default_request_params.model or DEFAULT_RESPONSES_MODEL
        model = ModelDatabase.resolve_wire_model_name(provider=self.provider, model_name=raw_model)
